        ...
        if ( have_posts() ) :
			...
			<header class="entry-header">
				...
				<div class="entry-content">
					<?php the_content(); ?>
					<?php 
						$product_select = $smof_data['product_select']; 
						$page = get_page_by_path($product_select); // get page by slug name
						echo sp_child_page_lists_basic($page->ID, 'menu_order', 435, 250, 'list');
					?>
				</div><!-- .entry-content -->
			</article><!-- #post -->
		<?php endwhile;
