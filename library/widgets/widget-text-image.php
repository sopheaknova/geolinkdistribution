	...
	*/
    ...
    function form( $instance )
    {
       ...
       <p>
        ...
        <p>
        <textarea id="<?php echo $this->get_field_id( 'txt' ); ?>" name="<?php echo $this->get_field_name( 'txt' ); ?>" class="widefat" cols="20" rows="10"><?php echo $instance['txt']; ?></textarea>
        </p>
    ...
    function widget( $args, $instance )
    {
		...
		if ( $link ) :
			...
			$widget_body = '<a href="' . $link . '"><img src="' . $instance['image'] . '" /></a>';
