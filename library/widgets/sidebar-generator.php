...
if( ! class_exists( 'avia_sidebar' ) )
{
	class avia_sidebar
	{
		...
		{
		    $this->paths['css']   = SP_ASSETS_ADMIN . 'css/';
		    $this->paths['js']    = SP_ASSETS_ADMIN . 'js/';
		    $this->stored         = 'avia_sidebars';
		    $this->title          = SP_THEME_NAME ." ". __('Custom Widget Area','avia_framework');
		...
		function template_add_widget_field()
		{
            ...
            echo "\n    <input class='button button-primary button-large' type='submit' value='".__('Add Widget Area')."' />";
            echo "\n    ".$nonce;
            echo "\n  </form>";
            echo "\n</script>\n";
		}
