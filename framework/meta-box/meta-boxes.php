...
$meta_boxes[] = array(
	'id'      => 'client-link',
	'title'   => __('Client Link', 'sptheme_admin'),
	'pages'   => array('sp_client'),
	'context' => 'normal',
	'priority'=> 'high',
	'fields'  => array(
		array(
			'name'  => __('Enter the url of client link.', 'sptheme_admin'),
			'id'    => $prefix.'client_url',
			'type'  => 'text',
			'std'   => '',
			'desc'  => 'e.g: https://wordpress.com/'
		)
	)
);
...
/* ---------------------------------------------------------------------- */
$meta_boxes[] = array(
	'id'      => 'testimonail-position',
	'title'   => __('Testimonail Position', 'sptheme_admin'),
	'pages'   => array('sp_testimonial'),
	'context' => 'normal',
	'priority'=> 'high',
	'fields'  => array(
		array(
			'name'  => __('Enter your position ', 'sptheme_admin'),
			'id'    => $prefix.'user_position',
			'type'  => 'text',
			'std'   => '',
			'desc'  => 'e.g: Supervisor, Developer, General Manager'
		)
	)
);
