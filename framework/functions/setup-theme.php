...
function sp_register_styles() {	
	...
	if( !is_admin() ) {
		...
		wp_register_style( 'skin-css', SP_BASE_URL . 'css/skin.css', false, THEME_VERSION );
...
function sp_register_scripts() {
	...
	wp_register_script( 'jquery',   SP_BASE_URL.'js/jquery-1.8.2.js', array(), '1.8.2', false );
	wp_register_script( 'modernizr_custom',  SP_BASE_URL . 'js/modernizr.custom.39801.js', array(), THEME_VERSION, false );
	//wp_register_script( 'video-js',          SP_BASE_URL . 'js/video-js.min.js', array(), THEME_VERSION, false );
	wp_register_script( 'selectivizr',       SP_BASE_URL . 'js/selectivizr-1.0.2/selectivizr-min.js', array('jquery'), THEME_VERSION, true );
	//wp_register_script( 'audioplayerv1',     SP_BASE_URL . 'js/audioplayerv1.min.js', array('jquery'), THEME_VERSION, true ); 
	wp_register_script( 'jquery-cycle',       SP_BASE_URL . 'js/jquery.cycle.all.min.js', array('jquery'), THEME_VERSION, true );
	wp_register_script( 'jquery-easing',     SP_BASE_URL . 'js/jquery.easing.1.3.js', array('jquery'), THEME_VERSION, true ); 
	wp_register_script( 'jcarousel',          SP_BASE_URL . 'js/jquery.jcarousel.min.js', array(), THEME_VERSION, false );
